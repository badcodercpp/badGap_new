            ...
            <View style={{width,height,backgroundColor:colors.primary,position:"absolute",zIndex:25}} >
                <View style={{flex:1,flexDirection:"column",justifyContent:"center",alignItems:"center"}} >
                    <TextInput
                            ...
                            autoFocus={true} 
                            style={{backgroundColor: colors.primary,color:colors.accent,flex:1,width:(width/2)-25,height:15,fontSize:20,borderBottomColor:"#800000",borderBottomWidth:1,height:15,marginBottom:10,paddingBottom:0,fontFamily:"Helvetica"}}
                    />
                </View>
